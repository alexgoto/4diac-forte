...
FOREACH(FORTE_MODULE_DIR ${FORTE_MODULE_LIST})
  ...
  ENDFOREACH(MODULE)
  set(MODULE_LIST )
  file(WRITE ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists_new.txt ${WRITE_FILE})
...
foreach(FORTE_MODULE_DIR ${FORTE_MODULE_LIST})
  ...
  execute_process( COMMAND ${CMAKE_COMMAND} -E compare_files ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists_new.txt ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists.txt RESULT_VARIABLE test_not_successful OUTPUT_QUIET ERROR_QUIET )
  if(test_not_successful)
    file(REMOVE ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists.txt)
    file(RENAME ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists_new.txt ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists.txt)
  ENDIF( test_not_successful)
  file(REMOVE ${FORTE_BINARY_DIR}/src/${FORTE_MODULE_DIR}/CMakeLists_new.txt)
endforeach(FORTE_MODULE_DIR)
